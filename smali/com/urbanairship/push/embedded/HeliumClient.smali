...
.method public constructor <init>(Ljava/net/Socket;Lcom/urbanairship/push/embedded/BoxOfficeClient;)V
    ...
    iput-wide v0, p0, Lcom/urbanairship/push/embedded/HeliumClient;->lastKeepAlive:J
...
.method private handleFailure(Lcom/urbanairship/push/proto/Rpc$Request;)V
    .locals 1

    const-string v0, "Got a bad request!"
...
.method public static protoReliers(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private sendRequest(Lcom/urbanairship/push/proto/Messages$AirshipMethod;Lcom/google/protobuf/ByteString;)V
    ...
    iget-object v2, p0, Lcom/urbanairship/push/embedded/HeliumClient;->out:Ljava/io/OutputStream;

    invoke-virtual {v2, v1}, Ljava/io/OutputStream;->write([B)V

    iget-object v1, p0, Lcom/urbanairship/push/embedded/HeliumClient;->out:Ljava/io/OutputStream;

    invoke-virtual {v0, v1}, Lcom/urbanairship/push/proto/Rpc$Request;->writeTo(Ljava/io/OutputStream;)V
    :try_end_0
...
.method public getLastKeepAlive()J
    ...
    iget-wide v0, p0, Lcom/urbanairship/push/embedded/HeliumClient;->lastKeepAlive:J

    return-wide v0
.end method

.method public handleNotification(Lcom/urbanairship/push/proto/Messages$PushNotification;)V
    .locals 4
...
.method public handleRegistration(Lcom/urbanairship/push/proto/Messages$RegistrationResponse;)V
    .locals 7

    const-string v0, "Registration response received!"
    ...
    invoke-static {}, Lcom/urbanairship/push/embedded/EmbeddedPushManager;->sendRegistrationResponse()V
    ...
    invoke-virtual {v1}, Lcom/urbanairship/push/embedded/BoxOfficeClient;->getCurrentServerAddress()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/urbanairship/push/embedded/BoxOfficeClient;->resetFailureCount(Ljava/lang/String;)V
...
.method public readResponse()V
    ...
    const-string v0, "keepalive read"
    ...
    :cond_0
    sget-object v1, Lcom/urbanairship/push/embedded/BoxOfficeClient;->currentKey:Ljava/util/UUID;

    if-nez v1, :cond_1

    new-instance v0, Lcom/urbanairship/push/embedded/HeliumClient$HeliumException;

    const-string v1, "key unknown!"
    ...
    sget-object v2, Lcom/urbanairship/push/embedded/BoxOfficeClient;->currentKey:Ljava/util/UUID;
    ...
    invoke-virtual {p0, v0}, Lcom/urbanairship/push/embedded/HeliumClient;->handleRegistration(Lcom/urbanairship/push/proto/Messages$RegistrationResponse;)V
    ...
    invoke-virtual {p0, v0}, Lcom/urbanairship/push/embedded/HeliumClient;->handleNotification(Lcom/urbanairship/push/proto/Messages$PushNotification;)V

    goto :goto_0

    :cond_3
    invoke-direct {p0, v0}, Lcom/urbanairship/push/embedded/HeliumClient;->handleFailure(Lcom/urbanairship/push/proto/Rpc$Request;)V
